...
var UncontrolledTabs = function (_Component) {
  ...
  function UncontrolledTabs() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.tabNodes = [], _this.handleKeyDown = function (e) {
      if (_this.isTabFromContainer(e.target)) {
        ...
        var disabledUpDownArrowKey = _this.props.disabledUpDownArrowKey;
  ...
  UncontrolledTabs.prototype.render = function render() {
    ...
    var _props2 = this.props,
        ...
        disabledUpDownArrowKey = _props2.disabledUpDownArrowKey,
        focus = _props2.focus,
        ...
        attributes = _objectWithoutProperties(_props2, ['children', 'className', 'disabledTabClassName', 'disabledUpDownArrowKey', 'focus', 'forceRenderTabPanel', 'onSelect', 'selectedIndex', 'selectedTabClassName', 'selectedTabPanelClassName']);
